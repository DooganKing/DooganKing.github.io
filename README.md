...
<div class="page">
    ...
    <div class="highlight-box">
        ...
        <ul style="font-size: 16px;">
            ...
            <li style="margin-bottom: 25px;">
                <span class="number" style="display: inline; margin: 0; min-width: auto; font-size: 28px;">3</span>
                <div style="display: inline-block; vertical-align: top; width: calc(100% - 60px); margin-left: 10px;">
                    <strong>Experimental Gameplay Hunger</strong><br>
                    <span style="font-size: 14px; color: #9ca3af;">Community wants deeper, weirder systems beyond standard formulas</span>
                </div>
            </li>
            <li>
                <span class="number" style="display: inline; margin: 0; min-width: auto; font-size: 28px;">4</span>
                <div style="display: inline-block; vertical-align: top; width: calc(100% - 60px); margin-left: 10px;">
                    <strong>Indie Success Stories</strong><br>
                    <span style="font-size: 14px; color: #9ca3af;">Games like Lethal Company prove weird concepts can dominate</span>
                </div>
            </li>
        </ul>
    </div>
...
<div class="page">
    <h1>The Ask</h1>
    <div class="center" style="margin-bottom: 40px;">
        <h2 style="font-size: 42px; margin-bottom: 15px;">Seeking Partnership</h2>
        <p style="font-size: 22px;">Publishing, funding, or development support to accelerate roadmap</p>
    </div>
    <div class="grid-2">
        <div class="box">
            <h4 style="margin-bottom: 15px;">What We Need</h4>
            <ul style="font-size: 14px;">
                <li>Development funding for team expansion</li>
                <li>Marketing and community growth support</li>
                <li>Publishing expertise for Steam launch</li>
                <li>Technical infrastructure for multiplayer</li>
            </ul>
        </div>
        <div class="box">
            <h4 style="margin-bottom: 15px;">What You Get</h4>
            <ul style="font-size: 14px;">
                <li>Unique game in hot genre</li>
                <li>Engaged early community</li>
                <li>Proven development progress</li>
                <li>Passionate, transparent solo dev</li>
            </ul>
        </div>
    </div>
    <div class="center stat-box" style="margin-top: 30px; padding: 25px;">
        <p style="font-size: 18px; margin: 0;">Let's build the weirdest roguelike in space together.</p>
    </div>
</div>
